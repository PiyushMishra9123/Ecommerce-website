    ...
    <div className="min-h-screen bg-slate-50 py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-10">
          ...
          <p className="text-sm uppercase tracking-wider font-bold text-orange-600 mb-2">
            Order Management
          </p>
              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pb-5 border-b border-slate-100">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-3 py-1.5 rounded-lg bg-orange-50 text-orange-600 text-sm font-bold">
                      Returned
                    </span>
                ...
                {/* RETURN INFO */}
                <div className="mt-5 p-5 rounded-2xl bg-orange-50 border border-orange-100">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6 pt-5 border-t border-slate-100">
                  ...
                  <div className="px-4 py-2 rounded-xl bg-orange-50 text-orange-600 font-bold text-sm">
                    Return Process
                  </div>
