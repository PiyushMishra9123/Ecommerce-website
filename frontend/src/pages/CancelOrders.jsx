    ...
    <div className="min-h-screen bg-slate-50 py-6 sm:py-8 lg:py-10 overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-7 sm:mb-10">
          <p className="text-xs sm:text-sm uppercase tracking-wider font-bold text-red-600 mb-2">
            Order Management
          </p>
        ...
        <div className="premium-card p-5 sm:p-6 mb-6 sm:mb-8">
          <div className="flex items-start sm:items-center gap-4">
            ...
            <div className="w-12 h-12 sm:w-14 sm:h-14 flex-shrink-0 rounded-2xl bg-red-50 flex items-center justify-center text-xl sm:text-2xl">
              ✕
            </div>
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-5 border-b border-slate-100">
                  ...
                  <div className="flex items-center gap-2 self-start sm:self-auto">
                    ...
                    <span className="px-3 py-1.5 rounded-lg bg-red-50 text-red-600 text-xs sm:text-sm font-bold">
                      Cancelled
                    </span>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-5 sm:mt-6 pt-5 border-t border-slate-100">
                  ...
                  <div className="self-start sm:self-auto px-4 py-2 rounded-xl bg-red-50 text-red-600 font-bold text-xs sm:text-sm">
                    Order Cancelled
                  </div>
